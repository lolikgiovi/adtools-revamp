...
import { language as sqlLanguage, conf as sqlConf } from 'monaco-editor/esm/vs/basic-languages/sql/sql.js';
...
export class QuickQueryUI {
  ...
  registerOracleSqlLanguage() {
    try {
      // Use the standard Monaco SQL language and configuration
      if (!monaco.languages.getLanguages().some(l => l.id === 'sql')) {
        monaco.languages.register({ id: 'sql', aliases: ['SQL'] });
      }
