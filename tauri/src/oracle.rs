...
//! between environments. Primary Oracle operations are now handled by the Python
...
// ============================================================================
// NOTE: Oracle Instant Client bundling was removed in Phase 4.10.
// We now use the Python sidecar with oracledb in thin mode, which doesn't
// require any native Oracle client libraries.
// ============================================================================
...
// NOTE: check_oracle_client_ready, prime_oracle_client, and debug_oracle_setup
// commands were removed in Phase 4.10. Oracle operations now use the Python sidecar.
...
// Phase 6.4: compare_configurations and compare_raw_sql functions removed.
