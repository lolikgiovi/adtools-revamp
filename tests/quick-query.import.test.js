...
import { importSchemasPayload } from '../app/tools/quick-query/services/SchemaImportService.js';
import { LocalStorageService } from '../app/tools/quick-query/services/LocalStorageService.js';
...
describe('SchemaImportService (KV nested tables payload)', () => {
  ...
  it('imports new_data_model_schema.json and persists tables', () => {
    const jsonPath = path.resolve(__dirname, '../app/tools/quick-query/new_data_model_schema.json');
